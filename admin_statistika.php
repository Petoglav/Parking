...
<nav>
    ...
    <div id="statistika">
        ...
        <tbody>
        <?php
            $upit="SELECT tvrtka.parkiraliste_id, parkiraliste.naziv, AVG(MINUTE(datum_vrijeme_odlaska)-MINUTE(datum_vrijeme_dolaska)) AS prosjek
    ...
    <div> 
        ...
        <tbody>
        <?php
            $upit="SELECT tvrtka.tvrtka_id, tvrtka.opis, tvrtka.naziv, AVG(MINUTE(datum_vrijeme_odlaska)-MINUTE(datum_vrijeme_dolaska)) AS prosjek
